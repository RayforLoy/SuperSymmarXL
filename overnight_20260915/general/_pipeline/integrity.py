...
R = Path('D:\\_Camera\\LensRebuild\\SuperSymmarXL\\overnight_20260915\\general');v=json.loads((R/'validated.json').read_text());records=[]
try:
 ...
 for name in v['files']:
  ...
  for row in v['surfaces']:
   ...
   assert ss.Conic==0. and row['conic']==0., 'All GENERAL conics must be zero'
