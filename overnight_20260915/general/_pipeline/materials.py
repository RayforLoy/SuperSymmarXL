...
try:
 ...
 if 'general'=='cdgm':assert all_cdgm,'CDGM phase requires all six native materials to resolve unambiguously through CDGM catalogs in use'
 result={'phase':'general','source_sha256':v['source_sha256'],'model_sha256':hashlib.sha256(model.read_bytes()).hexdigest(),
