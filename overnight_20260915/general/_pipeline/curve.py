...
parser=argparse.ArgumentParser();parser.add_argument('--input',default='SuperSymmarXL_150_GENERAL_f5p6.zmx');args=parser.parse_args()
...
R = Path('D:\\_Camera\\LensRebuild\\SuperSymmarXL\\overnight_20260915\\general');sys.LoadFile(str(R/args.input),False)
...
for bi,hs in enumerate(batches):
 ...
 for fn in values:
  ...
  print('GENERAL curve batch',bi+1,fn,flush=True)
