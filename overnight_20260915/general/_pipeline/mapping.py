...
parser.add_argument('--model', type=Path, default=Path('D:\\_Camera\\LensRebuild\\SuperSymmarXL\\overnight_20260915\\general\\SuperSymmarXL_150_GENERAL_f5p6.zmx'))
...
try:
    ...
    # Explicit same entrance pupil convention as the existing GENERAL evaluator.
