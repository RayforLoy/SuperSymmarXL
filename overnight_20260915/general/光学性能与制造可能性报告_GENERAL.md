# Super-Symmar XL 150 mm f/5.6 光学性能与制造可能性报告 - GENERAL

## 方案与材料身份

面型与材料通用优化方案。本报告仅引用本方案冻结 best 的原生复算，不将其等同于旧 R4 材料或处方。材料替换并不自动带来性能提高或实测降本。

| 片 / 前面 | 历史参考玻璃 | 本方案原生材料 | 原生目录候选 |
| --- | --- | --- | --- |
| L1 / S1 | KF9 | KF9 | SCHOTT |
| L2 / S3 | N-LAK33B | H-LAK53A | CDGM |
| L3 / S5 | N-LAK33B | N-LAK33B | SCHOTT |
| L4 / S8 | N-SK5 | N-SK5 | SCHOTT |
| L5 / S9 | F2 | F2 | SCHOTT, CDGM |
| L6 / S11 | K10 | K10 | SCHOTT |
...
样点数 |
| --- | --- | --- | --- |
| f/5.6 | 10.43 | 20 / 48 | 37 / 48 |
| f/8 | 9.88 | 46 / 60 | 53 / 60 |
| f/22 | 9.98 | 34 / 78 | 66 / 78 |
...
本报告不为不同光圈分别移动像面。末面到像面名义距离为 135.26379885 mm。三文件同像面已由验证数据明确记录。 三档记录：f/5.6: 135.26379885 mm；f/8: 135.26379885 mm；f/22: 135.26379885 mm。原厂聚焦程序的完全等效性仍须由实际验证流程确认，不能仅凭焦距与像距接近推断。
...
百分点 | 最大不足的位置 |
| --- | --- | --- | --- |
| f/5.6 | 1024 | 0.121 | 10.0% / 20 lp/mm T |
| f/8 | 512 | 0.090 | 40.0% / 10 lp/mm T |
| f/22 | 512 | 0.102 | 60.0% / 20 lp/mm S |
...
| --- | --- | --- |
| S2 - S3 | 25.800 | 10.39479 |
| S4 - S5 | 15.000 | 11.97868 |
| S6 - S8 | 14.400 | 5.12378 |
| S10 - S11 | 15.800 | 0.67342 |

## 最后两片的保守检查

对 S10 非球面与 S11 末片前球面，保守将球面延伸至 S10 的通光半径再增加 0.3 mm 读图余量，检查结果最小空气间隙为 0.67342 mm。全部受检空气间隙最小值为 0.67342 mm。另检查六片玻璃在共同有效口径内的局部厚度。以上是名义光学面几何检查，未包含压圈、倒角、胶层、装配偏心与温度误差；不能当作装配间隙的公差保证。结构图中的直线边缘连接仅为示意。
...
| --- | --- | --- | --- | --- |
| 1 | 186.759382 | 3.549090 | KF9 | 41.0000 |
| 2 | 33.339783 | 12.326029 | 空气 | 29.0000 |
| 3 | 37.483276 | 15.970796 | H-LAK53A | 25.8000 |
| 4 | 60.426060 | 11.978678 | 空气 | 19.5000 |
| 5 | 36.556651 | 2.875620 | N-LAK33B | 15.0000 |
| 6 | 43.620063 | 4.856498 | 空气 | 14.5000 |
| 7 光阑 | 平面 | 1.683139 | 空气 | 14.2224 |
| 8 | 101.216116 | 13.425794 | N-SK5 | 14.4000 |
| 9 | -24.034977 | 4.529007 | F2 | 14.4000 |
| 10 | -41.641799 | 0.985870 | 空气 | 15.5000 |
| 11 | -40.860781 | 5.074079 | K10 | 14.0000 |
| 12 | 202.299699 | 135.263799 | 空气 | 18.8000 |
...
| --- | --- | --- |
| 圆锥常数 k | 0.0 | 无量纲 |
| A4 | 3.362984286177e-06 | mm^(-3) |
| A6 | 2.467127296064e-09 | mm^(-5) |

## 结构变化按最终数据统计

以下变化由最终 GENERAL 与 R2 的 validated.json 逐面比较得出，不假设本轮实际使用了哪组优化变量或限制。未列出的对应数值在 1e-8 mm 比较阈值内一致。S12 间隔变化表示共同像面的变化，不是镜片中心厚度。

| 面号 | GENERAL - R2 |
| --- | --- |
| S1 | R -14.317724 mm；间隔 +0.149090 mm |
| S2 | R -0.035974 mm；间隔 -0.673971 mm |
| S3 | R +0.209260 mm；间隔 -0.059204 mm；玻璃 N-LAK33B -> H-LAK53A |
| S4 | R +0.116294 mm；间隔 +0.342678 mm |
| S5 | R -0.041333 mm；间隔 -0.324380 mm |
| S6 | R -0.088612 mm；间隔 +0.016597 mm |
| S7 | 间隔 +0.463040 mm；口径半径 -0.055282 mm |
| S8 | R +2.200940 mm；间隔 +0.325794 mm |
| S9 | R -0.221191 mm；间隔 -0.170993 mm |
| S10 | R +0.562734 mm；间隔 -0.004130 mm |
| S11 | R -0.382667 mm；间隔 -0.225921 mm |
| S12 | R -1.285903 mm；间隔 -0.137743 mm |

## 非球面与一阶参数变化

A4、A6 系数相对 R2 对应项的差值依次为：+5.661697e-07；-1.705574e-08。R2/R3 的非零高阶项属于历史候选，本轮没有沿用它们。本轮有效焦距为 148.045370 mm，入瞳位置为 36.746816 mm，首面到末面的轴向长度为 77.254600 mm。原厂公开对应值约为 148.1、36.6、77.4 mm；参数接近不代表完整处方已被唯一恢复。
...
S10 有效半径 15.500 mm；参考为处方指定顶点半径球面，不是拟合最佳球面。设计离开量范围 0.000 至 228.324 μm，PV 228.324 μm；最大绝对表面斜率 0.337703 mm/mm，最大绝对斜率离开量 0.063337 mm/mm；最大绝对表面倾角 18.6600°。这些是设计面形及斜率，不能称为要求工厂达到的误差公差。

![非球面设计轮廓](asphere_profile.png)

| 镜片 / 玻璃 | 中心厚度 mm | 共同口径边缘厚度 mm | 受检最薄处 mm |
| --- | --- | --- | --- |
| L1 / KF9 | 3.54909 | 18.17544 | 3.54909 |
| L2 / H-LAK53A | 15.97080 | 13.73206 | 13.73206 |
| L3 / N-LAK33B | 2.87562 | 2.35751 | 2.35751 |
| L4 / N-SK5 | 13.42579 | 7.60494 | 7.60494 |
| L5 / F2 | 4.52901 | 6.91783 | 4.52901 |
| L6 / K10 | 5.07408 | 8.03233 | 5.07408 |

## 厚度检查范围

采用 20001 个均匀径向样点，曲面导数按储存的圆锥加偶次多项式解析计算。镜片厚度只覆盖前后光学面的共同有效口径，未定义的倒角和机械外缘不在检查域内。制造指标中的保守后组间隙为 0.67342 mm；这也不是带公差的装配最小间隙。

## 审核文件与方法

原生审核模型：SuperSymmarXL_150_GENERAL_f5p6.zmx。审核的末面像距 135.26379885 mm；入瞳单位圆每波长 1257 个均匀笛卡尔网格射线，6 个波长。主光线使用原生真实光线并与 REAY 交叉检查。审核不保存或改写交付 ZMX。

| 光圈 | 公开对照场最大映射偏差 mm | 公开对照场最大相对畸变 % | 轴上 / 全场边缘几何瞳份额 % |
| --- | --- | --- | --- |
| f/5.6 | 1.42407 | 1.0851 | 100.00 / 16.35 |
| f/8 | 1.46457 | 1.0851 | 100.00 / 33.60 |
| f/22 | 1.46457 | 1.0851 | 100.00 / 99.66 |
...
| 光圈 | 原生相对照度审核 |
| --- | --- |
| f/5.6 | 首列相对照度：轴上 1.000000，扫描终点 0.022131；范围 0.022131 至 1.000000 |
| f/8 | 首列相对照度：轴上 1.000000，扫描终点 0.044996；范围 0.044996 至 1.000000 |
| f/22 | 首列相对照度：轴上 1.000000，扫描终点 0.131367；范围 0.131367 至 1.000000 |
...
按 f/5.6、轴上 20 lp/mm、256 采样扫描统一像面。正式像面平均 T/S MTF 为 0.619441；扫描最佳样点位于正式像面 +0.000000 mm，MTF 0.619441，增益 0.0000 个百分点。最佳点位于扫描内部；这是有限网格局部扫描，不能直接证明全局最佳聚焦。 正式像面与扫描最佳样点重合，满足本次有限网格局部扫描的原厂轴上最大化检查。
