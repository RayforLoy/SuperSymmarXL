# Super-Symmar XL 150 mm f/5.6 逆向工程

状态：**尚未通过 MTF 等效筛选；不可称为原厂等效或生产定版**。
...
本轮总体 MTF RMSE 为 7.09 个百分点；最大绝对偏差 30.86 个百分点。原厂扫描图的人工读数仍有约 2–4 个百分点不确定度。完整验收判据见 analysis/acceptance.json。按当前估计口径，非球面后存在约 0.185 mm 的边缘表面交叠，尚不满足制造条件。
