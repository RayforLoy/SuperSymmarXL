...
for h in [38.6,77.2,115.8,135.1,154.4,193]:sys.SystemData.Fields.AddField(0,h,1)
# rows: relative image height; columns T5,S5,T10,S10,T20,S20.
target={5.6:[[.90,.90,.79,.79,.64,.64],[.66,.80,.47,.59,.32,.40],[.48,.68,.28,.41,.055,.28],[.42,.58,.215,.32,.07,.235],[.39,.53,.21,.28,.09,.20]],8:[[.94,.94,.865,.865,.79,.79],[.80,.92,.60,.78,.39,.57],[.67,.79,.41,.57,.14,.40],[.54,.53,.30,.35,.14,.26],[.43,.40,.24,.25,.10,.18]],22:[[.905,.905,.82,.82,.66,.66],[.90,.90,.77,.815,.62,.655],[.87,.89,.705,.80,.485,.63],[.78,.87,.545,.77,.30,.59],[.72,.85,.455,.72,.19,.51],[.615,.82,.34,.64,.07,.39],[.45,.74,.20,.485,.03,.24]]}
(ROOT/'analysis'/'target_manual.json').write_text(json.dumps({'note':'Manual approximate digitization of supplied Schneider PDF p2 infinity row; ~0.02-0.04 uncertainty; T dashed, S radial solid','heights':[0,.2,.4,.6,.7,.8,1.0],'data':target},indent=2))
...
def fun(x):
 ...
 return res
r=least_squares(fun,x0,bounds=bounds,diff_step=1e-4,max_nfev=100,verbose=0,ftol=2e-5,xtol=2e-5)
apply(r.x)
