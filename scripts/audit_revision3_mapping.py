"""Read-only native ZOS audit. Run only after optimization instances exit.
...
parser.add_argument('--model', type=Path, default=P/'revision3/SuperSymmarXL_150_R3_f5p6.zmx')
...
report = {'model': str(args.model.resolve()), 'read_only_zmx': True,
...
try:
    ...
    # Explicit same entrance pupil convention as the existing R3 evaluator.
