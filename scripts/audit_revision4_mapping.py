...
parser.add_argument('--model', type=Path, default=P/'revision4/SuperSymmarXL_150_R4_f5p6.zmx')
...
try:
    ...
    # Explicit same entrance pupil convention as the existing R4 evaluator.
