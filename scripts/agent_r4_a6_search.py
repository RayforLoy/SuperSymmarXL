...
OUT=core.ROOT/'revision4'/'agent_search'
NORM=15.5
...
def main():
    p=argparse.ArgumentParser();p.add_argument('--seed',default=str(core.ROOT/'revision3'/'agent_search'/'higher7_asphereonly1_best.zmx'))
    p.add_argument('--target',default=str(core.ROOT/'revision3'/'target_optimization.json'))
    p.add_argument('--name',default='a6_smooth1');p.add_argument('--size',type=int,default=128)
    p.add_argument('--iterations',type=int,default=20);p.add_argument('--max-jacobians',type=int,default=5)
